...
#ifndef DESCARGOBIENESMB_H
#define DESCARGOBIENESMB_H
...
namespace Ui {
    class DescargoBienesMB;
}

class DescargoBienesMB : public QWidget {
    Q_OBJECT
public:
    DescargoBienesMB(RegistroCatalogo *_regCatalogo, contabilidad::RegistroSistemaContable *regC, basico::Registro  *registroBasico, InventarioActivoFijo *_inventario, QWidget *parent = 0);
    ~DescargoBienesMB();
...
private slots:
    void on_anioInventario_currentIndexChanged(QString );
};

#endif // DESCARGOBIENESMB_H
