...
class ingresoBienes : public QWidget {
    Q_OBJECT
public:
    ingresoBienes( contabilidad::RegistroSistemaContable *regC, basico::Registro  *registroBasico, InventarioActivoFijo *_inventario, QWidget *parent = 0);
    ~ingresoBienes();

    void closeEvent(QCloseEvent *event);
    void setTabla(int idIngreso, QList<QTableWidgetItem *>);
...
private:
    ...
    int numeroTran, fila, columna, idIngreso;
    float valorTotal;
    QString estadoIngreso, estadoBien;
    bool nuevoIngreso;
...
private slots:
    void on_btmGuardar_pressed();
    void on_btmMarcas_clicked();
    void on_btmBuscarEspecifico_clicked();
    void on_btmBuscarClases_clicked();
};
