...
public:
    ...
    void setupUi(QWidget *CatalogoActivoFijoGUI)
    {
        ...
        groupBox_2->setGeometry(QRect(290, 60, 281, 211));
        ...
        descripcion->setGeometry(QRect(20, 160, 241, 20));
        ...
        btmBuscar->setGeometry(QRect(500, 330, 61, 41));
        QIcon icon5;
        ...
        btmSeleccionar->setGeometry(QRect(280, 330, 111, 41));
        QIcon icon6;
        ...
        pushButton->setGeometry(QRect(400, 330, 91, 41));
        QIcon icon7;
        ...
        label_17->setGeometry(QRect(650, 20, 51, 51));
        ...
        plainTextEdit->setGeometry(QRect(720, 20, 151, 61));
