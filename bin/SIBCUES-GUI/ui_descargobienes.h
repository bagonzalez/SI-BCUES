...
#ifndef UI_DESCARGOBIENES_H
#define UI_DESCARGOBIENES_H
...
public:
    ...
    void setupUi(QWidget *DescargoBienes)
    {
        ...
        gridLayout_4->addWidget(cuentaNO, 1, 0, 1, 1);
        ...
        gridLayout_4->addWidget(claseNO, 1, 1, 1, 1);
        ...
        gridLayout_4->addWidget(correlativoNO, 1, 2, 1, 1);
