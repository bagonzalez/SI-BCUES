...
public:
    ...
    void setupUi(QWidget *CatalogoActivoFijoGUI)
    {
        ...
        tabWidget->setGeometry(QRect(20, 80, 871, 441));
        ...
        btmSeleccionar->setGeometry(QRect(370, 250, 81, 31));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/iconos/button_ok.png"), QSize(), QIcon::Normal, QIcon::Off);
        btmSeleccionar->setIcon(icon5);
        pushButton = new QPushButton(tab_3);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(370, 290, 81, 31));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/iconos/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton->setIcon(icon6);
        btmBuscar = new QPushButton(tab_3);
        btmBuscar->setObjectName(QString::fromUtf8("btmBuscar"));
        btmBuscar->setGeometry(QRect(370, 330, 81, 31));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/Iconos/iconos/buscar.png"), QSize(), QIcon::Normal, QIcon::Off);
        btmBuscar->setIcon(icon7);
        ...
        label = new QLabel(CatalogoActivoFijoGUI);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(400, 20, 91, 16));
        anioInventario = new QComboBox(CatalogoActivoFijoGUI);
        anioInventario->setObjectName(QString::fromUtf8("anioInventario"));
        anioInventario->setGeometry(QRect(400, 50, 121, 22));
    ...
    void retranslateUi(QWidget *CatalogoActivoFijoGUI)
    {
        ...
        btmSeleccionar->setText(QApplication::translate("CatalogoActivoFijoGUI", "Seleccionar", 0, QApplication::UnicodeUTF8));
        ...
        label->setText(QApplication::translate("CatalogoActivoFijoGUI", "Inventario:", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
