...
public:
    ...
    void setupUi(QWidget *TrasladoActivoFijo)
    {
        ...
        gridLayout->addWidget(groupBox, 0, 3, 1, 3);
        ...
        gridLayout->addWidget(observaciones, 12, 2, 1, 3);
        ...
        gridLayout->addWidget(widget, 13, 4, 1, 1);
        ...
        gridLayout->addWidget(tablaBienes, 4, 0, 4, 5);
        ...
        gridLayout->addWidget(botonAgregarBien, 4, 5, 1, 1);
        ...
        gridLayout->addWidget(botonEliminarBien, 5, 5, 1, 1);
        ...
        gridLayout->addWidget(nuevoBien, 6, 5, 1, 1);
        ...
        gridLayout->addWidget(totalIngreso, 11, 2, 1, 1);
    ...
    void retranslateUi(QWidget *TrasladoActivoFijo)
    {
        ...
        label_7->setText(QApplication::translate("TrasladoActivoFijo", "Inventario:", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
